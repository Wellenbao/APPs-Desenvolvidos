package com.example.jogodonmero;
...
public class Jogodonumero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogodonumero);
    ...
    public void clickBtnTentar(View v) {
        ...
        if (valor == valorOculto) {
            ...
            mp = MediaPlayer.create(Jogodonumero.this,R.raw.aplauso);
            mp.start(); }
        else {
            mp = MediaPlayer.create(Jogodonumero.this,R.raw.erro);
            mp.start();
    ...
    public void clickBtnReset(View v) {
