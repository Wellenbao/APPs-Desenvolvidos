...
public class bdModel extends SQLiteOpenHelper {
    ...
    public static int getDbVersao() { return dbVersao; }
    ...
    public String criarTabela(){
        ...
        @Override
        public void onCreate(SQLiteDatabase db) { db.execSQL(criarTabela()); }
    ...
    public ArrayList<credencialModel> select(){
        ...
        Cursor cursor = dataBase.query(getTabela(),
                colunas,null, null, null, null, null, null);
